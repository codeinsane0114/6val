  ...
  // ℹ️ This plugin should be placed before vue plugin
    VueRouter({
      ...
      beforeWriteFiles: root => {
        root.insert('/apps/email/:filter', '/resources/js/pages/6val/adminpage/apps/email/index.vue')
        root.insert('/apps/email/:label', '/resources/js/pages/6val/adminpage/apps/email/index.vue')
      },
