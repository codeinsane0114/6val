...
const menuItems = [
  {
    ...
    navItems: [
      {
        name: 'Pricing',
        to: { name: '6val-adminpage-front-pages-pricing' },
      },
      {
        name: 'Payment',
        to: { name: '6val-adminpage-front-pages-payment' },
      },
      {
        name: 'Checkout',
        to: { name: '6val-adminpage-front-pages-checkout' },
      },
      {
        name: 'Help Center',
        to: { name: '6val-adminpage-front-pages-help-center' },
      },
    ],
  },
  {
    ...
    navItems: [
      {
        name: 'Login (Basic)',
        to: { name: '6val-adminpage-pages-authentication-login-v1' },
      },
      {
        name: 'Login (Cover)',
        to: { name: '6val-adminpage-pages-authentication-login-v2' },
      },
      {
        name: 'Register (Basic)',
        to: { name: '6val-adminpage-pages-authentication-register-v1' },
      },
      {
        name: 'Register (Cover)',
        to: { name: '6val-adminpage-pages-authentication-register-v2' },
      },
      {
        name: 'Register (Multi-steps)',
        to: { name: '6val-adminpage-pages-authentication-register-multi-steps' },
      },
      {
        name: 'Forgot Password (Basic)',
        to: { name: '6val-adminpage-pages-authentication-forgot-password-v1' },
      },
      {
        name: 'Forgot Password (Cover)',
        to: { name: '6val-adminpage-pages-authentication-forgot-password-v2' },
      },
      {
        name: 'Reset Password (Basic)',
        to: { name: '6val-adminpage-pages-authentication-reset-password-v1' },
      },
      {
        name: 'Reset Password (cover  )',
        to: { name: '6val-adminpage-pages-authentication-reset-password-v2' },
      },
    ],
  },
  {
    ...
    navItems: [
      {
        ...
        to: { name: '6val-adminpage-pages-misc-under-maintenance' },
      },
      {
        name: 'Coming Soon',
        to: { name: '6val-adminpage-pages-misc-coming-soon' },
      },
      {
        name: 'Not Authorized',
      ...
      },
      {
        ...
        to: { name: '6val-adminpage-pages-authentication-verify-email-v1' },
      },
      {
        name: 'Verify Email (Cover)',
        to: { name: '6val-adminpage-pages-authentication-verify-email-v2' },
      },
      {
        name: 'Two Steps (Basic)',
        to: { name: '6val-adminpage-pages-authentication-two-steps-v1' },
      },
      {
        name: 'Two Steps (Cover)',
        to: { name: '6val-adminpage-pages-authentication-two-steps-v2' },
      },
    ],
  },
]
      ...
      <div>
        <div class="d-flex flex-column gap-y-4 pa-4">
          <RouterLink
            ...
            :key="index"
            :to="{ name: '6val-adminpage-front-pagesages-landing-page', hash: `#${item.toLowerCase().replace(' ', '-')}` }"
        ...
        <div class="d-flex align-center">
          ...
          <div class="text-base align-center d-none d-md-flex">
            <RouterLink
              v-for="(item, index) in ['Home', 'Features', 'Team', 'FAQ', 'Contact us']"
              :key="index"
              :to="{ name: '6val-adminpage-front-pages-landing-page', hash: `#${item.toLowerCase().replace(' ', '-')}` }"
