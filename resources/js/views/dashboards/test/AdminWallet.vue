...
const statisticsTarget = [
  {
    ...
    stats: data?.data ? data.data.inhouse_earning : null,
    change: 39892.00,
...
const logisticData = ref([
  {
    ...
    value: data?.data ? data.data.commission_earned : null,
    change: 18.2,
    isHover: true,
  },
  {
    ...
    value: data?.data ? data.data.delivery_charge_earned : null,
    change: -8.7,
    isHover: false,
  },
  {
    ...
    value: data?.data ? data.data.inhouse_earning : null,
    change: 4.3,
    isHover: false,
  },
  {
    ...
    value: data?.data ? data.data.pending_amount : null,
    change: -2.5,
    isHover: false,
  },
])
