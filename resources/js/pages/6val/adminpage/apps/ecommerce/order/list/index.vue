    ...
    <VCard>
      ...
      >
        ...
        <template #item.order="{ item }">
          <RouterLink :to="{ name: '6val-adminpage-apps-ecommerce-order-details-id', params: { id: item.order } }">
            #{{ item.order }}
          </RouterLink>
        </template>
          ...
          <IconBtn>
            ...
            <VMenu activator="parent">
              <VList>
                <VListItem
                  value="view"
                  :to="{ name: '6val-adminpage-apps-ecommerce-order-details-id', params: { id: item.order } }"
                >
                  View
                </VListItem>
                <VListItem
