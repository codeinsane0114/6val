...
definePage({
  meta: {
    navActiveLink: '6val-adminpage-pages-user-profile-tab',
    key: 'tab',
  },
})

const route = useRoute('6val-adminpage-pages-user-profile-tab')
  ...
  <div>
    ...
    >
      <VTab
        ...
        :key="item.icon"
        :value="item.tab"
        :to="{ name: '6val-adminpage-pages-user-profile-tab', params: { tab: item.tab } }"
      >
        <VIcon
          size="20"
          start
