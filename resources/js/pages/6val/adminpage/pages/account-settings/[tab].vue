...
const route = useRoute('6val-adminpage-pages-account-settings-tab')
...
definePage({ meta: { navActiveLink: '6val-adminpage-pages-account-settings-tab' } })
</script>
  ...
  <div>
    ...
    >
      <VTab
        ...
        :key="item.icon"
        :value="item.tab"
        :to="{ name: '6val-adminpage-pages-account-settings-tab', params: { tab: item.tab } }"
      >
        <VIcon
          size="20"
          start
